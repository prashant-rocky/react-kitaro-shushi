...
const Disclaimer = () => {
  return (
    <div className="container py-5">
      ...
      <h4>1. Menu & Pricing</h4>
      <p>
        Menu items, descriptions, and prices listed on this website are subject
        to change without prior notice. The actual menu and pricing at our
        restaurant may vary.
      </p>
